...
public class Client implements ActionListener {
    ...
    Client(){
         ...
         phone.setBounds(360, 23, 20, 20);
         p1.add(phone);
         
         
         ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("icons/3icon.png"));
         Image i14 = i13.getImage().getScaledInstance(5 , 15, Image.SCALE_DEFAULT);
         ImageIcon i15 = new ImageIcon(i14);
         JLabel morevert = new JLabel(i15);
         morevert.setBounds(420, 25, 5, 15);
         p1.add(morevert);
         ...
         status.setBounds(111, 40, 100, 18);
